...
2. **Create a `.env` file** in the Backend directory (see `ENV_CONFIG.md` for details):
```env
PORT=5000
...
3. **Make sure MongoDB is running** on your system. If you don't have MongoDB installed locally, you can use [MongoDB Atlas](https://www.mongodb.com/cloud/atlas) for a free cloud database.
...
The server will automatically create the `uploads` directory if it doesn't exist.
...
3. **Configure environment variables:**
   - Copy the example environment variables from `ENV_CONFIG.md`
